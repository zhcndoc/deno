...
title: "Web 开发"
description: "使用 Deno 进行 Web 开发指南。了解 Fresh、Next.js 和 Astro 等支持的框架，以及用于构建现代 Web 应用的内置功能。"
oldUrl:
...
[React](https://reactjs.org/) 是一个流行的用于构建用户界面的 JavaScript 库。要在 Deno 中使用 React，你可以采用流行的 Web 框架 [Next.js](https://nextjs.org/)。
...
[Vite](https://vitejs.dev/) 是一款 Web 开发构建工具，它通过原生 ES 模块提供代码，使这些代码可以直接在浏览器中运行。Vite 是构建现代 Web 应用的绝佳选择，适合 Deno。
