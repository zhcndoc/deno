...
- [deno create](/runtime/reference/cli/create/) - 从模板搭建新项目
- [deno doc](/runtime/reference/cli/doc/) - 为模块生成文档
- [deno deploy](/runtime/reference/cli/deploy) - 管理并发布你的网络项目
...
- [deno lint](/runtime/reference/cli/lint/) - 代码风格检查
