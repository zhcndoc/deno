...
var _GroupSelectEvent = class _GroupSelectEvent extends Event {
  groupId;
  tabId;
...
__name(_GroupSelectEvent, "GroupSelectEvent");
var GroupSelectEvent = _GroupSelectEvent;
...
var storedSandboxLang = localStorage.getItem("deno-tab-sandbox-sdk");
