...
title: "快速入门"
description: "创建并配置您的第一个 Deno Deploy 应用的分步指南，包括组织设置、构建配置、环境变量以及部署监控。"
---

## 创建组织

Deno Deploy Classic 将于 2026 年 7 月 20 日关闭。如果您正在从 Deploy Classic 迁移，请参阅 [迁移指南](/deploy/migration_guide/) 了解变更详情。
...
![Deno Deploy 组织创建屏幕。](./images/create_org.png)
...
对于已完成的构建，右上角会显示预览 URL。下方会显示此构建已部署到的所有时间线，例如 `Production` 或 `Git Branch` 时间线。
...
完成后右上角显示预览 URL，及构建版本所部署的所有时间线（如 `Production` 或 `Git Branch`）。
